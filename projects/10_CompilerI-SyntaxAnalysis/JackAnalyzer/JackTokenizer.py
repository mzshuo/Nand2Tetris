...
class JackTokenizer:
    ...
    def token_type(self):
        ...
        if self.curr_token in JackLexicon.symbol:
            return JackLexicon.SYMBOL
        elif self.curr_token in JackLexicon.keyword:
            return JackLexicon.KEYWORD
        elif self.curr_token.isdigit():
            return JackLexicon.INT_CONST
        elif self.curr_token[0] == '"':
            return JackLexicon.STRING_CONST
        else:
            return JackLexicon.IDENTIFIER
...
if __name__ == '__main__':
    input = 'ArrayTest/Main.jack'
    # input = 'ExpressionLessSquare/Main.jack'
    # input = 'ExpressionLessSquare/Square.jack'
    # input = 'ExpressionLessSquare/SquareGame.jack'
    # input = 'Square/Main.jack'
    # input = 'Square/Square.jack'
    # input = 'Square/SquareGame.jack'

    tokenizer = JackTokenizer(input)
    tokenizer.test(input)
